...
router.route('/producers/:id').get(producers.get_producer_id); // will have products in it and have schedules
...
router.route('/producers/:id/old-products').get(producers.get_producer_id_old_products);
...
router.route('/products/:id').get(products.get_products); // will have producer's info
